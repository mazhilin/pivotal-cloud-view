...
t = this, e = function () {
    ...
    function s(t) {
        ...
        return (t = t.trim().replace(/^(\?|#|&)/, "")) ? (t.split("&").forEach(function (t) {
            var r = t.replace(/\+/g, " ").split("="), n = u(r.shift()), o = r.length > 0 ? u(r.join("=")) : null;
    ...
    function S(t) {
        ...
        return function (r, n) {
            for (var o = "", i = r || {}, a = (n || {}).pretty ? C : encodeURIComponent, c = 0; c < t.length; c++) {
                var u = t[c];
                if ("string" != typeof u) {
                    var s, p = i[u.name];
                    if (null == p) {
    ...
    function q(t, e, r) {
        ...
        for (var n = (r = r || {}).strict, o = !1 !== r.end, i = "", a = 0; a < t.length; a++) {
            ...
            if ("string" == typeof c) i += $(c); else {
                var u = $(c.prefix), s = "(?:" + c.pattern + ")";
                e.push(c), c.repeat && (s += "(?:" + u + s + ")*"), i += s = c.optional ? c.partial ? u + "(" + s + ")?" : "(?:" + u + "(" + s + "))?" : u + "(" + s + ")"
            }
        }
        var p = $(r.delimiter || "/"), f = i.slice(-p.length) === p;
    ...
    function V(t, e, n, o) {
        ...
        var u = function (t) {
        ...
        }(i.path || ""), p = e && e.path || "/", f = u.path ? b(u.path, p, n || i.append) : p, h = function (t, e, r) {
            void 0 === e && (e = {});
            var n, o = r || s;
            try {
                n = o(t || "")
            ...
            return n
        }(u.query, i.query, o && o.options.parseQuery), l = i.hash || u.hash;
        return l && "#" !== l.charAt(0) && (l = "#" + l), {_normalized: !0, path: f, query: h, hash: l}
    }

    var B, H = [String, Object], z = [String, Array], D = function () {
    }, F = {
        name: "RouterLink",
        props: {
        ...
        render: function (t) {
            var e = this, n = this.$router, o = this.$route, i = n.resolve(this.to, o, this.append), a = i.location,
                c = i.route, u = i.href, s = {}, p = n.options.linkActiveClass, l = n.options.linkExactActiveClass,
                d = null == p ? "router-link-active" : p, v = null == l ? "router-link-exact-active" : l,
            ...
            if ("a" === this.tag) k.on = x, k.attrs = {href: u}; else {
                var E = function t(e) {
    ...
    function J(t, e, r, n) {
        ...
        t.forEach(function (t) {
            !function t(e, r, n, o, i, a) {
                var c = o.path, u = o.name, s = o.pathToRegexpOptions || {}, p = function (t, e, r) {
                ...
                if (o.children && o.children.forEach(function (o) {
                    ...
                    var d = h[l], v = {path: d, children: o.children};
                    t(e, r, n, v, i, f.path || "/")
                }
                u && (n[u] || (n[u] = f))
            }(o, i, a, t)
    ...
    function X(t, e) {
        var r = J(t), n = r.pathList, o = r.pathMap, i = r.nameMap;

        function a(t, r, a) {
            var c = V(t, r, !1, e), s = c.name;
            if (s) {
                var p = i[s];
        ...
        function c(t, r) {
            var n = t.redirect, o = "function" == typeof n ? n(h(t, r, null, e)) : n;
            if ("string" == typeof o && (o = {path: o}), !o || "object" != typeof o) return u(null, r);
            var c = o, s = c.name, p = c.path, f = r.query, l = r.hash, d = r.params;
            return f = c.hasOwnProperty("query") ? c.query : f, l = c.hasOwnProperty("hash") ? c.hash : l, d = c.hasOwnProperty("params") ? c.params : d, s ? (i[s], a({
                _normalized: !0,
                name: s,
                query: f,
                hash: l,
    ...
    function Y(t, e, r) {
        ...
        for (var o = 1, i = n.length; o < i; ++o) {
            var a = t.keys[o - 1], c = "string" == typeof n[o] ? decodeURIComponent(n[o]) : n[o];
    ...
    function nt() {
        ...
        window.history.replaceState({key: tt()}, "", e), window.addEventListener("popstate", function (t) {
    ...
    function lt(t, e) {
        ...
        try {
            e ? r.replaceState({key: tt()}, "", t) : r.pushState({key: et(G())}, "", t)
        } catch (r) {
        ...
        return function (r, n, o) {
            ...
            mt(e, function (e, r, n, u) {
                if ("function" == typeof e && void 0 === e.cid) {
                    i = !0, a++;
                    var s, p = wt(function (t) {
                        var r;
                        ((r = t).__esModule || bt && "Module" === r[Symbol.toStringTag]) && (t = t.default), e.resolved = "function" == typeof t ? t : B.extend(t), n.components[u] = t, --a <= 0 && o()
                    }), f = wt(function (e) {
    ...
    kt.prototype.listen = function (t) {
        ...
        var i = this, a = this.current, c = function (r) {
        ...
        var u = function (t, e) {
            ...
            }(this.current.matched, r.matched), s = u.updated, p = u.deactivated, f = u.activated,
            h = [].concat(function (t) {
    ...
    var Ot = function (t) {
        function e(e, r) {
            var n = this;
            t.call(this, e, r);
            var o = e.options.scrollBehavior, i = ht && o;
            i && nt();
            var a = _t(this.base);
            window.addEventListener("popstate", function (t) {
                var r = n.current, o = _t(n.base);
    ...
    var At = function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.setupListeners = function () {
            var t = this, e = this.router.options.scrollBehavior, r = ht && e;
            r && nt(), window.addEventListener(ht ? "popstate" : "hashchange", function () {
                var e = t.current;
                jt() && t.transitionTo(Ct(), function (n) {
    ...
    return Lt.prototype.match = function (t, e, r) {
    ...
    }, Lt.version = "3.1.3", K && window.Vue && window.Vue.use(Lt), Lt
}, "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).VueRouter = e();