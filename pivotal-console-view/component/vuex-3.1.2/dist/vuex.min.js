...
!function (t, e) {
    ...
    s.prototype.get = function (t) {
        ...
        !function t(e, n, o) {
            n.update(o);
            if (o.modules) for (var i in o.modules) {
    ...
    function h(t, n, o) {
        ...
        r.config.silent = !0, t._vm = new r({
            data: {$$state: n},
            computed: a
        }), r.config.silent = c, t.strict && function (t) {
    ...
    function p(t, e, n, o, i) {
        ...
        if (o.namespaced && (t._modulesNamespaceMap[a], t._modulesNamespaceMap[a] = o), !s && !i) {
            var c = l(e, n.slice(0, -1)), u = n[n.length - 1];
        ...
        var f = o.context = function (t, e, n) {
            var o = "" === e, i = {
                dispatch: o ? t.dispatch : function (n, o, i) {
                    var r = d(n, o, i), s = r.payload, a = r.options, c = r.type;
        ...
        o.forEachMutation(function (e, n) {
            ...
            var o = e.root ? n : a + n, i = e.handler || e;
            !function (t, e, n, o) {
                (t._actions[e] || (t._actions[e] = [])).push(function (e) {
                    ...
                    return (i = r) && "function" == typeof i.then || (r = Promise.resolve(r)), t._devtoolHook ? r.catch(function (e) {
    ...
    c.state.get = function () {
        ...
        var o = this, i = d(t, e, n), r = i.type, s = i.payload, a = {type: r, payload: s}, c = this._mutations[r];
        ...
        var n = this, o = d(t, e), i = o.type, r = o.payload, s = {type: i, payload: r}, a = this._actions[i];
        if (a) {
            try {
